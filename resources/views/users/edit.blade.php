        ...
        <div class="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <p class="text-amber-100 text-sm mt-1">Update user information</p>
                </div>
    ...
    <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white rounded-2xl shadow-xl border border-amber-100 overflow-hidden">
            <div class="bg-gradient-to-r from-amber-50 to-orange-50 px-6 py-4 border-b border-amber-100">
                ...
                <p class="text-sm text-gray-500 mt-1">Update user details (roles cannot be changed after creation)</p>
            </div>
            ...
            <form method="POST" action="{{ route('users.update', $user) }}" class="p-6">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="address" rows="2"
                              class="w-full rounded-xl border-2 border-gray-200 focus:border-amber-500 focus:ring-2 focus:ring-amber-200 p-3">{{ old('address', $user->address) }}</textarea>
                </div>
