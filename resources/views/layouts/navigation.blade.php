    ...
    <div :class="{'block': open, 'hidden': !open}" class="hidden md:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <div class="relative" x-data="{ openReports: false }">
                <button @click="openReports = !openReports" class="w-full text-left pl-3 pr-4 py-2 text-base font-medium text-amber-600 hover:text-amber-800 hover:bg-amber-50 flex justify-between items-center">
                    <span>Reports</span>
