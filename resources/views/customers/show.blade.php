                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div class="pt-4 border-t">
                            <div class="flex justify-between mb-2">
                                ...
                                <span class="text-lg font-bold {{ $customer->current_balance > 0 ? 'text-red-600' : 'text-green-600' }}">
            ...
            <div class="lg:col-span-2">
                <div class="bg-white rounded-2xl shadow-xl border border-amber-100 overflow-hidden">
                    <div class="bg-gradient-to-r from-amber-50 to-orange-50 px-6 py-4 border-b border-amber-100">
                        ...
                        <p class="text-sm text-gray-500 mt-1">Recent transactions</p>
                    </div>
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                                ...
                                <div class="text-right">
                                    ...
                                    <p class="text-xs text-gray-500">{{ $sale->items->count() }} items</p>
                                </div>
                            </div>
                            @endforeach
                            ...
                            <div class="text-center mt-4">
                                <a href="#" class="text-amber-600 hover:text-amber-800 text-sm">View all transactions →</a>
                            </div>
                            @endif
                        </div>
                        @else
