            ...
            <form method="GET" class="flex gap-4 items-end">
                <div class="flex-1">
                    ...
                    <input type="month" name="month" value="{{ $month }}" 
                           class="w-full rounded-lg border-2 border-gray-300 focus:border-amber-500 focus:ring-amber-500 focus:outline-none px-4 py-2">
                </div>
                <div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            <td colspan="7" class="px-6 py-12 text-center">
                                ...
                                <p class="text-sm text-gray-400 mt-1">Try selecting a different month</p>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
