...
class ReportController extends Controller
{
        ...
        public function profitLoss(Request $request)
    {
        ...
        $totalSales = \App\Models\Sale::whereBetween('sale_date', [$startDate, $endDate])
            ->where('status', 'completed')
            ->sum('total');
        
        // Calculate Cost of Goods Sold (from sale items)
        $totalCost = \App\Models\SaleItem::whereHas('sale', function($q) use ($startDate, $endDate) {
        ...
        $totalPurchases = \App\Models\Purchase::whereBetween('purchase_date', [$startDate, $endDate])
            ->where('status', 'completed')
            ->sum('total');
        ...
        $dailyData = \App\Models\Sale::whereBetween('sale_date', [$startDate, $endDate])
            ->where('status', 'completed')
            ->select(
